...
const operationsItems: LinkItem[] = [
  { label: "Operations Dashboard", href: "/operations" }, { label: "Product Orders", href: "/operations/orders" }, { label: "Service Jobs", href: "/operations/service-jobs" }, { label: "Material Requests", href: "/operations/material-requests" }, { label: "Material Pickups", href: "/operations/material-pickups" }, { label: "Delivery Partners", href: "/operations/delivery-partners" }, { label: "Delayed Orders", href: "/operations/delayed" }, { label: "Reassignments", href: "/operations/reassignments" },
];
