  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Dispatch & Rider Assignment</Text>
        <View style={{ width: 24 }} />
      </View>
      ...
      <View style={styles.centerContent}>
        ...
        <Text style={styles.title}>Delivery Rider Dispatch Disabled</Text>
        <Text style={styles.description}>
          Delivery rider assignment, courier dispatch, and rider OTP verification are disabled across all FixKart apps. All fulfillment is centered on Plumber Self-Pickup from hardware stores.
        </Text>
        <View style={styles.pill}>
          <Text style={styles.pillText}>FEATURE_DELIVERY_ENABLED = false</Text>
        </View>
        ...
        >
          <Text style={styles.actionBtnText}>Return to Material Requests</Text>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
  );
