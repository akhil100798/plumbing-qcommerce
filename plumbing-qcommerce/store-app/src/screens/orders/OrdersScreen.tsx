  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Standalone Product Orders</Text>
        <View style={{ width: 24 }} />
      </View>
      ...
      <View style={styles.centerContent}>
        ...
        <Text style={styles.title}>Standalone Product Orders Deferred</Text>
        <Text style={styles.description}>
          Direct B2C standalone product order checkout is deferred across all FixKart apps. All store fulfillment is centered on Plumber Field Service Material Requests.
        </Text>
        <View style={styles.pill}>
          <Text style={styles.pillText}>CORE FULFILLMENT = PLUMBER MATERIAL REQUESTS</Text>
        </View>
