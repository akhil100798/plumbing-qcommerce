...
export function AfterPhotosScreen({ route, navigation }: Props) {
  ...
  const handleCapture = () => {
    // Simulate camera snapshot capture of finished pipe fittings
  ...
  const handleContinue = () => {
    ...
    // Navigate to Complete Service Screen
      ...
      <ScrollView contentContainerStyle={styles.content}>
        <View style={styles.instructions}>
          ...
          <Text style={styles.subtitle}>
            Take clear photos of the setup after completing the work.
          </Text>
        </View>
